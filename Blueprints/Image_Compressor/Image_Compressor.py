...
imgCompressor_bp = Blueprint('imgCompressor_bp', __name__, template_folder='templates', static_folder='static', static_url_path='/Compressor/static')

UPLOAD_FOLDER = 'Blueprints/Image_Compressor/static/uploads'
OUTPUT_FOLDER = 'Blueprints/Image_Compressor/static/outputs'
...
def download_file(filename):
    return send_from_directory(os.path.join(imgCompressor_bp.static_folder, 'outputs'), filename, as_attachment = True)