...
imgBW2Color_bp = Blueprint('imgBW2Color_bp', __name__, template_folder='templates')

UPLOAD_FOLDER = 'static/Image_BW2Color/uploads'
OUTPUT_FOLDER = 'static/Image_BW2Color/outputs'
MODEL_DIR = 'models'
...
def index():
    return render_template("index_color.html", show_image=False)
...
def colorize():
    ...
    if file and allowed_file(file.filename):
        ...
        try:
            ...
            img_url = url_for('static', filename=f'Image_BW2Color/outputs/{output_filename}')
            download_url = url_for('imgBW2Color_bp.download_file', filename=output_filename)

            return render_template("index_color.html", show_image=True, output_img=img_url, download_url=download_url)
