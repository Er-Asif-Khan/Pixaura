...
imgResizer_bp = Blueprint('imgResizer_bp', __name__, template_folder= 'templates', static_folder= 'static', static_url_path='/Resizer/static')

UPLOAD_FOLDER = 'Blueprints/Image_Resizer/static/uploads'
OUTPUT_FOLDER = 'Blueprints/Image_Resizer/static/outputs'
